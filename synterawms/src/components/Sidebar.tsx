...
import { LayoutDashboard, Boxes, TruckIcon, BarChart3, Database, Settings, ChevronDown, ChevronRight, Search, Headphones, Circle, ArrowDownToLine } from 'lucide-react';
...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Adjustment', href: '/inventory/adjustment', icon: <Circle size={8} /> },
    ],
  },
  {
    label: 'Outbound',
      ...
      <div className="px-4 py-3 border-b sidebar-border">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-white text-sm font-semibold truncate">SuperAdmin</p>
            <div className="flex items-center gap-1">
              <span className="w-2 h-2 rounded-full bg-success flex-shrink-0" />
              <span className="text-xs sidebar-text">Online</span>
            </div>
            <p className="text-xs sidebar-text truncate">Super Admin ↓</p>
          </div>
        </div>
      </div>
